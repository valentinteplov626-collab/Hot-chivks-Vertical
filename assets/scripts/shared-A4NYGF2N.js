...
var setErrorSyncMetrics = () => {
    ...
    const handleEmptyAppConfig = () => {
        var _a;
        const dataVer = ((_a = document.querySelector("html")) == null ? void 0 : _a.getAttribute("data-env")) || "";
        if (dataVer === "production-archive" && !Object.keys(APP_CONFIG).length) {
            syncMetric({
                event: "error",
                errorMessage: "Empty APP_CONFIG",
                errorSubType: "EmptyAppConfig",
                errorType: "CUSTOM"
            });
        }
    };
